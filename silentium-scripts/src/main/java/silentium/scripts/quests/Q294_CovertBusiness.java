...
public class Q294_CovertBusiness extends Quest implements ScriptFile {
	...
	public Q294_CovertBusiness(final int scriptId, final String name, final String dname, final String path) {
	...
	public static void onLoad() {
		new Q294_CovertBusiness(294, "Q294_CovertBusiness", "Covert Business", "quests");
	}
