...
public class Q045_ToTalkingIsland extends Quest implements ScriptFile {
	...
	public Q045_ToTalkingIsland(final int scriptId, final String name, final String dname, final String path) {
	...
	public static void onLoad() {
		new Q045_ToTalkingIsland(45, "Q045_ToTalkingIsland", "To Talking Island", "quests");
	}
