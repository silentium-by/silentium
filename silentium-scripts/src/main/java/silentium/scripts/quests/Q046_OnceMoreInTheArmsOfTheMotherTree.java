...
public class Q046_OnceMoreInTheArmsOfTheMotherTree extends Quest implements ScriptFile {
	...
	public static void onLoad() {
		new Q046_OnceMoreInTheArmsOfTheMotherTree(46, "Q046_OnceMoreInTheArmsOfTheMotherTree", "Once More In The Arms Of The Mother Tree", "quests");
	}
	...
	public String onTalk(final L2Npc npc, final L2PcInstance player) {
		...
		switch (st.getState()) {
			case QuestState.CREATED:
				if (player.getRace().ordinal() == 1 && player.getLevel() >= 3 && player.getLevel() <= 10) {
