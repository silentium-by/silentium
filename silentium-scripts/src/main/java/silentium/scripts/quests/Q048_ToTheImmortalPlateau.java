...
public class Q048_ToTheImmortalPlateau extends Quest implements ScriptFile {
	...
	public Q048_ToTheImmortalPlateau(final int scriptId, final String name, final String dname, final String path) {
	...
	public static void onLoad() {
		new Q048_ToTheImmortalPlateau(48, "Q048_ToTheImmortalPlateau", "To The Immortal Plateau", "quests");
	}
