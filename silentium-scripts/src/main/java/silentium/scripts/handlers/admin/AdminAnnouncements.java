 ...
 * reload_announcements = reloads announcements from txt file - announce_announcements = announce all stored announcements to all
 * players - add_announcement text = adds text to startup announcements - del_announcement id = deletes announcement with
 * respective id
 */
