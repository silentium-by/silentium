...
public class FleeNpc extends DefaultMonsterAI implements ScriptFile {
	// Victims and elpies
	...
	public FleeNpc(final int questId, final String name, final String descr) {
		super(questId, name, descr);

		for (final int element : _npcId)
