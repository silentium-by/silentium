...
/**
 * This class is particular : <li>loads generic petdata (L2PetData), such as maxLoad, foodId,...</li> <li>loads generated data from XML (stats)
 * aswell (L2PetLevelData) : patk, matk, pdef, mdef, HPs,...</li>
 **/
