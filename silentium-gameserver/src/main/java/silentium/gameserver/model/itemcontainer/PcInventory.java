...
public class PcInventory extends Inventory
{
	 ...
	 * @param itemId
	 * @return
	 * @see silentium.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, boolean)
	 */
	 ...
	 * @param enchantment
	 * @return
	 * @see silentium.gameserver.model.itemcontainer.PcInventory#getAllItemsByItemId(int, int, boolean)
	 */
