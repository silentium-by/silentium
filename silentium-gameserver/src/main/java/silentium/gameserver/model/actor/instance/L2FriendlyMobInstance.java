...
import silentium.gameserver.model.actor.knownlist.FriendlyMobKnownList;
import silentium.gameserver.templates.chars.L2NpcTemplate;

/**
 * This class represents Friendly Mobs lying over the world. These friendly mobs should only attack players with karma > 0 and it
 * is always aggro, since it just attacks players with karma
 */
