...
public final class L2ArtefactInstance extends L2NpcInstance
{
	 ...
	 * MyTargetSelected to the L2PcInstance player (display the select window)</li> <li>Send a Server->Client packet
	 * ValidateLocation to correct the L2Npc position and heading on the client</li> <BR>
	 * <BR>
