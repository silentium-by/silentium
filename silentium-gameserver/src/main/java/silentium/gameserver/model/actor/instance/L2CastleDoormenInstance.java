...
public class L2CastleDoormenInstance extends L2DoormenInstance
{
	...
	protected final boolean isOwnerClan(L2PcInstance player)
	{
		...
		{/*
		 * if (getConquerableHall() != null) { // player should have privileges to open doors if (player.getClanId() ==
		 * getConquerableHall().getOwnerId() && (player.getClanPrivileges() & L2Clan.CP_CS_OPEN_DOOR) == L2Clan.CP_CS_OPEN_DOOR) return true; }
		 * else
		 */
			if (getCastle() != null)
			{
