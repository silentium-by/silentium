...
public class L2FishData
{
	...
	public L2FishData(int id, int lvl, String name, int HP, int HpRegen, int type, int group, int fish_guts, int guts_check_time, int wait_time, int combat_time)
	{
		_id = id;
		_level = lvl;
		_name = name.intern();
	...
	public L2FishData(L2FishData copyOf)
	{
		_id = copyOf.getId();
