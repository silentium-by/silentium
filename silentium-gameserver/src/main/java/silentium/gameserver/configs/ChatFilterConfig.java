...
public final class ChatFilterConfig extends ConfigEngine
{
	...
	{
		try (FileInputStream fileInputStream = new FileInputStream(CHAT_FILTER_FILE); InputStreamReader streamReader = new InputStreamReader(fileInputStream, "UTF-8"); LineNumberReader numberReader = new LineNumberReader(streamReader))
		{
