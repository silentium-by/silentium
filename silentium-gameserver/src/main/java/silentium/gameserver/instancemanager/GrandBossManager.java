...
{
	/*
	 * ========================================================= This class handles all Grand Bosses: <ul> <li>25333-25338 Anakazel</li>
	 * <li>29001 Queen Ant</li> <li>29006 Core</li> <li>29014 Orfen</li> <li>29019 Antharas</li> <li>29020 Baium</li> <li>29022 Zaken</li>
	 * <li>29028 Valakas</li> <li>29045 Frintezza</li> <li>29046-29047 Scarlet van Halisha</li> </ul> It handles the saving of hp, mp, location,
	 * and status of all Grand Bosses. It also manages the zones associated with the Grand Bosses. NOTE: The current version does NOT spawn the
	 * Grand Bosses, it just stores and retrieves the values on reboot/startup, for AI scripts to utilize as needed.
	 */
	...
	{
		FastMap<Integer, List<Integer>> zones = new FastMap<>();
