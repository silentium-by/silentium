...
{
	protected final static Logger _log = LoggerFactory.getLogger(RaidBossSpawnManager.class.getName());
	...
	public void updateStatus(L2RaidBossInstance boss, boolean isBossDead)
	{
		...
		if (isBossDead)
		{
			...
			long respawn_delay = Rnd.get((int) (RespawnMinDelay * 1000 * NPCConfig.RAID_MIN_RESPAWN_MULTIPLIER), (int) (RespawnMaxDelay * 1000 * NPCConfig.RAID_MAX_RESPAWN_MULTIPLIER));
	...
	private void updateDb()
	{
		...
		{
			_log.warn("SQL error while updating RaidBoss spawn to database: " + e.getMessage(), e);
		}
	}
