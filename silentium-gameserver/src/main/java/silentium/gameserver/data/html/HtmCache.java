...
public final class HtmCache {
	...
	public static final FilenameFilter BMP_FILTER = CustomFileNameFilter.create().setPattern(".bmp");
	public static final FilenameFilter HTM_FILTER = CustomFileNameFilter.create().setPattern(".htm");
