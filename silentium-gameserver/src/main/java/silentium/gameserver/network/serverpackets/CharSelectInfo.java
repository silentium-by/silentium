...
public class CharSelectInfo extends L2GameServerPacket
{
	...
	private static CharSelectInfoPackage restoreChar(ResultSet chardata) throws Exception
	{
		...
		/*
		 * Check if the base class is set to zero and alse doesn't match with the current active class, otherwise send the base
		 * class ID. This prevents chars created before base class was introduced from being displayed incorrectly.
		 */
