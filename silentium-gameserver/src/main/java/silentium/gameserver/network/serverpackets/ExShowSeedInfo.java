...
/**
 * format(packet 0xFE) ch ddd [dddddcdcd] c - id h - sub id d - manor id d d - size [ d - seed id d - left to buy d - started
 * amount d - sell price d - seed level c d - reward 1 id c d - reward 2 id ]
 * 
 * @author l3x
 */
