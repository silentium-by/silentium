...
/**
 * <font color="red">This packet still need rework. The Freya structure is different. Feets and bows aren't shown, and the fact getFromList()
 * returns 0 is wrong.</font><br>
 * <br>
