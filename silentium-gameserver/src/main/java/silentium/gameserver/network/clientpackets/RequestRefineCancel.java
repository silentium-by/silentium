...
import silentium.gameserver.network.serverpackets.ExVariationCancelResult;
...
public final class RequestRefineCancel extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			Util.handleIllegalPlayerAction(activeChar, activeChar.getName() + " of account " + activeChar.getAccountName() + " tried to augment an item he doesn't own.", MainConfig.DEFAULT_PUNISH);
			return;
		}
