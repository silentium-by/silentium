...
import silentium.gameserver.network.serverpackets.TradeItemUpdate;
import silentium.gameserver.network.serverpackets.TradeOtherAdd;
import silentium.gameserver.network.serverpackets.TradeOwnAdd;
...
public final class AddTradeItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (partner == null || L2World.getInstance().getPlayer(partner.getObjectId()) == null || partner.getActiveTradeList() == null)
		{
			...
			if (partner != null)
				log.warn(player.getName() + " requested invalid trade object: " + _objectId);
