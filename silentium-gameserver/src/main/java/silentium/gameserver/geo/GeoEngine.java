...
public class GeoEngine extends GeoData
{
	...
	// Public Methods
	/**
	 * @see silentium.gameserver.geo.GeoData#getType(int, int)
	 */
	@Override
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#getHeight(int, int, int)
	 */
	@Override
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#getSpawnHeight(int, int, int, int, L2Spawn)
	 */
	@Override
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#geoPosition(int, int)
	 */
	@Override
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#canSeeTarget(L2Object, Point3D)
	 */
	@Override
	...
	public boolean canSeeTarget(L2Object cha, L2Object target)
	{
		...
		if (!(target instanceof L2DoorInstance) && DoorData.getInstance().checkIfDoorsBetween(cha.getX(), cha.getY(), z, target.getX(), target.getY(), z2))
			return false;
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#canSeeTargetDebug(silentium.gameserver.model.actor.instance.L2PcInstance,
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#getNSWE(int, int, int)
	 */
	@Override
	...
	/**
	 * @see silentium.gameserver.geo.GeoData#moveCheck(int, int, int, int, int, int)
	 */
	@Override
	...
	private static void nInitGeodata()
	{
		...
		try
		{
			...
			File Data = new File("./data/world/geodata/geo_index.txt");
			if (!Data.exists())
				return;
		...
		try
		{
			File geo_bugs = new File("./data/world/geodata/geo_bugs.txt");
	...
	public static boolean loadGeodataFile(byte rx, byte ry)
	{
		...
		String fname = "./data/world/geodata/" + rx + "_" + ry + ".l2j";
		short regionoffset = (short) ((rx << 5) + ry);
	...
	private static short nGetType(int x, int y)
	{
		...
		if (geo == null)
		{
			_log.debug("Geo Region - Region Offset: " + region + " dosnt exist!!");
			return 0;
		}
	...
	private static short nGetSpawnHeight(int geox, int geoy, int zmin, int zmax, L2Spawn spawn)
	{
		...
		// multilevel
		{
			...
			{
				_log.debug("SpawnHeight Error - Couldnt find correct layer to spawn NPC - GeoData or Spawnlist Bug!: zmin: " + zmin + " zmax: " + zmax + " value: " + temph + " Spawn: " + spawn + " at: " + geox + " : " + geoy);
				return (short) zmin;
			}
		}
		if (temph > zmax + 1000 || temph < zmin - 1000)
		{
			_log.debug("SpawnHeight Error - Spawnlist z value is wrong or GeoData error: zmin: " + zmin + " zmax: " + zmax + " value: " + temph + " Spawn: " + spawn + " at: " + geox + " : " + geoy);
			return (short) zmin;
		}
		return temph;
	}
