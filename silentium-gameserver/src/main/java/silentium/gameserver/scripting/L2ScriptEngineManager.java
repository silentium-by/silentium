...
public final class L2ScriptEngineManager {
	...
	private static void registerHandlers() {
		try {
			...
			for (final Class<? extends IUserCommandHandler> userCommandHandler : reflections.getSubTypesOf
			...
			for (final Class<? extends IVoicedCommandHandler> voicedCommandHandler : reflections.getSubTypesOf
