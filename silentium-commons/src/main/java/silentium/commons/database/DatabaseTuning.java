...
public class DatabaseTuning {
	...
	private static final String GAME_SERVER_TABLES = "auction, auction_bid, augmentations, castle, " +
			"castle_doorupgrade, castle_manor_procure, castle_manor_production, castle_siege_guards, " +
			"character_friends, character_hennas, character_macroses, character_mail, character_premium, " +
			"character_quest_global_data, character_quests, character_raid_points, character_recipebook, " +
			"character_recommends, character_shortcuts, character_skills, character_skills_save, " +
			"character_subclasses, characters, clan_data, clan_notices, clan_privs, clan_skills, clan_subpledges, " +
			"clan_wars, clanhall, clanhall_functions, cursed_weapons, dimensional_rift, droplist, forums, games, " +
			"global_tasks, grandboss_data, grandboss_list, heroes, heroes_diary, items, itemsonground, " +
			"merchant_areas_list, merchant_buylists, merchant_shopids, merchants, minions, mods_wedding, npc, " +
			"npc_ai_data, npc_skills, olympiad_data, olympiad_fights, olympiad_nobles, olympiad_nobles_eom, pets, " +
			"posts, quest_global_data, raidboss_spawnlist, random_spawn, random_spawn_loc, seven_signs, " +
			"seven_signs_festival, seven_signs_status, siege_clans, skill_learn, spawnlist, spawnlist_4s, topic";
	...
	private enum DatabaseTuningType {
		OPTIMIZE(GAME_SERVER_TABLES_OPTIMIZE_QUERY, AUTH_SERVER_TABLES_OPTIMIZE_QUERY),
		CHECK(GAME_SERVER_TABLES_CHECK_QUERY, AUTH_SERVER_TABLES_CHECK_QUERY),
		REPAIR(GAME_SERVER_TABLES_REPAIR_QUERY, AUTH_SERVER_TABLES_REPAIR_QUERY);
